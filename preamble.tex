...
%\usepackage{parskip}
%=========================Packages==================================%
\usepackage{color,lscape, amsmath, hyperref, booktabs, latexsym, multicol, lmodern, natbib, graphicx, tikz, tkz-euclide, amssymb, enumitem, fancyhdr, lipsum, siunitx, setspace}
