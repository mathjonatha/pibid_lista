\begin{question}[type=exam] (\addpoints{60}) %pontuação da questão %caso queira que o enunciado tenha o nome "Exercício 1." e não "Questão", apague o a configuração [type=exam].
